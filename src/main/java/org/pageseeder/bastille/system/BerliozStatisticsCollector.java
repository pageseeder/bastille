 ...
 */
public final class BerliozStatisticsCollector implements GeneratorListener, XMLWritable {

  /**
   * Singleton instance.
   */
  private static final BerliozStatisticsCollector SINGLETON = new BerliozStatisticsCollector();
   ...
   */
  private BerliozStatisticsCollector() {
  }
